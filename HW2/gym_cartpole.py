...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            input_layer = tf.layers.flatten(self.observations, name="input_layer")
            hidden_layer = tf.layers.dense(input_layer, 4, activation=tf.nn.tanh, name="hidden_layer_1")
            hidden_layer = tf.layers.dense(hidden_layer, 2, activation=tf.nn.tanh, name="hidden_layer_2")
