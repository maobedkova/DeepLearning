...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            self.train_control = tf.placeholder(tf.bool, name="train_control")
            ...
            hidden_layer_dropout = tf.layers.dropout(hidden_layer, rate=args.dropout, training=self.train_control, name="dropout_layer")
    ...
    def train(self, images, labels):
        self.session.run([self.training, self.summaries["train"]], {self.images: images,
                                                                    self.labels: labels,
                                                                    self.train_control: True})

    def evaluate(self, dataset, images, labels):
        return self.session.run([self.accuracy, self.summaries[dataset]], {self.images: images,
                                                                    self.labels: labels,
